# Escreva um programa que pergunte a quantidade de km percorrridos po um carro alugado e a quantidade de dias pelos quais ele foi alugado. Calcule o preço a pagar, sabendo que o carro custa R$ 60 por dia e R$0.15 km rodado.
